...
//                    }
            ...
            function generateItemCard($image, $itemName, $itemPrice, $itemCode, $sellerID) {
                if ($sellerID == $_SESSION['UID']) {
                    ...
                    "	<!-- Block2 -->" .
                    "	<div class=\"block2\">" .
                    "<form method=\"post\" action=\"index.php?action=add&idproduct=$itemCode\">" .
                    "		<div class=\"block2-img wrap-pic-w of-hidden pos-relative block2-labelnew\">" .
                    "			<img src='" . $image . "' alt=\"IMG-PRODUCT\">" .
                    "			<div class=\"block2-overlay trans-0-4\">" .
                    "				<a href=\"#\" class=\"block2-btn-addwishlist hov-pointer trans-0-4\" aria-label=\"wishlist-button\">" .
...
// }
            ...
            if (isset($_GET['feedback'])) {
                if ($_GET['feedback'] == 1) {
                    echo "<div class='alert alert-success'>Your feedback has been sent and is much appreciated.</div>";
                } else {
                    echo "<div class='alert alert-danger'>There was an error sending your feedback. Please try again.</div>";
                }
            }
            ?>
                    ...
                    <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                        <div class="flex-sb-m flex-w p-b-35">
                            <div class="flex-w">
                                <div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
                                    <select class="selection-2" name="sorting" aria-label="sort-select">
                                ...
                                <div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
                                    <select class="selection-2" name="sorting" aria-label="price-select">
                                        <option>Price</option>
                        ...
                        <div class="pagination flex-m flex-w p-t-26">
                            <?php if (ceil($totalProducts / $limit) > 0): ?>
                                <ul class="pagination">
                                    <?php if ($page > 1): ?>
                                        <li class="prev"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page - 1 ?>">Prev</a></li>
                                    <?php endif; ?>

                                    <?php if ($page > 3): ?>
                                        <li class="start"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=1">1</a></li>
                                        <li class="dots">...</li>
                                    <?php endif; ?>

                                    <?php if ($page - 2 > 0): ?><li class="page"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a></li><?php endif; ?>
                                    <?php if ($page - 1 > 0): ?><li class="page"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a></li><?php endif; ?>

                                    <li class="currentpage"><a class="item-pagination flex-c-m trans-0-4 active-pagination" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page ?>"><?php echo $page ?></a></li>

                                    <?php if ($page + 1 < ceil($totalProducts / $limit) + 1): ?><li class="page"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page + 1 ?>"><?php echo $page + 1 ?></a></li><?php endif; ?>
                                    <?php if ($page + 2 < ceil($totalProducts / $limit) + 1): ?><li class="page"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page + 2 ?>"><?php echo $page + 2 ?></a></li><?php endif; ?>

                                    <?php if ($page < ceil($totalProducts / $limit) - 2): ?>
                                        <li class="dots">...</li>
                                        <li class="end"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo ceil($totalProducts / $limit) ?>"><?php echo ceil($totalProducts / $limit) ?></a></li>
                                    <?php endif; ?>

                                    <?php if ($page < ceil($totalProducts / $limit)): ?>
                                        <li class="next"><a class="item-pagination flex-c-m trans-0-4" href="index.php?category=<?php echo urlencode($currentCategory) ?>&page=<?php echo $page + 1 ?>">Next</a></li>
                                    <?php endif; ?>
                                </ul>
                            <?php endif; ?>
                        </div>
